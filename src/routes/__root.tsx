  ...
  head: () => ({
    meta: [
      ...
      { title: "LS Fencing & Metal Work — Fraser Valley Fence & Gate Contractor" },
      {
        name: "description",
        content:
          "Chain link, cedar, ornamental fencing, custom metal gates, welding & excavation across the Fraser Valley & Lower Mainland, BC. Free quotes.",
      },
      { name: "author", content: "LS Fencing & Metal Work" },
